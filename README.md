...
5. Метаданные задания сохраняются в PostgreSQL.
6. Задание передаётся ML-сервису через RabbitMQ.
...
Текущий набор содержит 1371 тест и покрывает unit-, MVC-, security-, repository-
и интеграционные сценарии. Полные интеграционные тесты ожидают доступные
...
- Политика retry/dead-letter для сообщений может потребовать расширения перед
