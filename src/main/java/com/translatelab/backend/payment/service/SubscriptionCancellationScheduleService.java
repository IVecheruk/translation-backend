...
@Service
public class SubscriptionCancellationScheduleService {
    ...
    public SubscriptionCancellationScheduleService(
    ...
    @Transactional
    public boolean processCancellationSchedule(
            SubscriptionCancellationScheduleCommand command
    ) {
        Objects.requireNonNull(
                command,
                "Команда запланированной отмены не должна быть null"
        );
