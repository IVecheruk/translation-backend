...
public class SubscriptionRenewalService {
    ...
    private static final String EVENT_TYPE = "SUBSCRIPTION_RENEWED";
    ...
    @Transactional
    public boolean processRenewal(SubscriptionRenewalCommand command) {
        Objects.requireNonNull(
                command,
                "Команда продления подписки не должна быть null"
        );
