...
@Service
public class SubscriptionPaymentRecoveryService {
    ...
    public SubscriptionPaymentRecoveryService(
    ...
    @Transactional
    public boolean processRecovery(
            SubscriptionPaymentRecoveryCommand command
    ) {
        Objects.requireNonNull(
                command,
                "Команда восстановления оплаты не должна быть null"
        );
